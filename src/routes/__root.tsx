...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Santé Ivoire — Compléments alimentaires & produits de santé" },
      ...
      { property: "og:title", content: "Santé Ivoire" },
      { property: "og:description", content: "Produits de santé authentiques livrés partout en Côte d'Ivoire." },
